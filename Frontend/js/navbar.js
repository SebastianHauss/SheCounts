document.querySelectorAll('[data-bs-toggle="modal"][data-bs-dismiss="modal"]').forEach(link => {
    link.addEventListener('click', function(e) {
        ...
        document.getElementById(currentModalId).addEventListener('hidden.bs.modal', function showNextModal() {
