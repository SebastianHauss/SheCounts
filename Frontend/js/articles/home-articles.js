document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        const images = {
            ...
            "49f4c9e9-f8a4-4da6-b854-92a3b4c257bd": "img/articles/finance-organization.jpg",
            ...
            "a9ae7d56-7047-4f8e-995c-d298644a37f5": "img/articles/finanzielle_abhängigkeit_font.jpg",
            "59b5462a-d2a4-413e-8491-f5027baf8517": "img/articles/minimalismus_font.png",
        };
        ...
        // MAIN BIG CARD
        const mainRes = await fetch(`http://localhost:8080/api/articles/${main.id}`, {
            // Public read – no login required
            credentials: "omit",
        });
        ...
        for (const article of others) {
            const articleRes = await fetch(`http://localhost:8080/api/articles/${article.id}`, {
                // Public read – no login required
                credentials: "omit",
            });
